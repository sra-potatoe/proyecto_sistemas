...
# Inicialización del reconocimiento facial
face_recognizer = cv2.face.LBPHFaceRecognizer_create()
face_recognizer.read("modelo_entrenado.xml")  # Reemplaza con la ubicación de tu modelo entrenado
...
def guardar_datos(detected_face):
...
while True:
    ...
    if len(faces) > 0:
        ...
        # Llama a la función de reconocimiento de rostros
        guardar_datos(detected_face)
