...
cred = credentials.Certificate("unifaceid1-firebase-adminsdk-ce27z-c9f589e48c.json")
firebase_admin.initialize_app(cred, {"storageBucket": "unifaceid1.appspot.com"})
...
def get_storage_data():
    try:
        ...
        storage_data = [{"name": blob.name,
                         "link": f"https://firebasestorage.googleapis.com/v0/b/unifaceid1.appspot.com/o/{blob.name}?alt=media&token={blob.public_url.split('=')[-1]}"}
